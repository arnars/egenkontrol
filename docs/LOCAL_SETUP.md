...
Dette dokument beskriver kun den forventede lokale kontekst. Installationskommandoer tilføjes først, når applikationen oprettes.
...
## Skal afklares ved projektoprettelse

- Krævet Node-version og package manager
